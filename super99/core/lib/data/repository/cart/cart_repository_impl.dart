...
class CartRepositoryImpl extends CartRepository {
  ...
  Future<Either<ErrorHandler, Cart>> updateCartItems(
      {required UpdateCartItemsInput updateCartItemsInput, required isGuestUser}) {
    return _cartDatasource
        ...
        .then((value) => value.fold(
              ...
              (cartDTO) => right(cartDTO.toDomain()),
            ));
  }

  @override
  Future<Either<ErrorHandler, Cart>> addProductToCart(List<AddProductToCart> addProductToCart,
      {required bool isGuestUser}) async {
    return (await _cartDatasource.addProductToCart(addProductToCart.map((e) => e.toDTO()).toList(),
  ...
  Future<Either<ErrorHandler, Cart>> removeProductFromCart(
      {required String cartId, required String cartItemId, required isGuestUser}) {
    return _cartDatasource
  ...
  Future<Either<ErrorHandler, Cart>> getCartInfo(String cartId, {required bool isGuestUser}) async {
    return (await _cartDatasource.getCartInfo(cartId, isGuestUser: isGuestUser)).fold(
      (errorHandler) => left(errorHandler),
      (cartDTO) => right(cartDTO.toDomain()),
    );
  }
  ...
  Future<Either<ErrorHandler, Cart>> setShippingAddressesOnCart(CustomerAddressEntity orderAddress, String cartId,
      {required isGuestUser, required SetShippingAddressOmsOptions setShippingAddressOmsOptions}) {
    return _cartDatasource
        .setShippingAddressesOnCart(orderAddress.toDTO(), cartId,
            isGuestUser: isGuestUser, setShippingAddressOmsOptionsDTO: setShippingAddressOmsOptions.toDTO())
        .then((value) => value.fold(
              (errorHandler) => left(errorHandler),
              (cartDTO) => right(cartDTO.toDomain()),
            ));
  ...
  Future<Either<ErrorHandler, Cart>> setBillingAddressesOnCart(CustomerAddressEntity orderAddress, String cartId,
      {required isGuestUser, required AddressOmsOptions addressOmsOptions}) {
    return _cartDatasource
        .setBillingAddressesOnCart(orderAddress.toDTO(), cartId,
            isGuestUser: isGuestUser, setBillingAddressOmsOptionsDTO: addressOmsOptions.toDTO())
        .then((value) => value.fold(
              (errorHandler) => left(errorHandler),
              (cartDTO) => right(cartDTO.toDomain()),
            ));
  ...
  Future<Either<ErrorHandler, Cart>> setPaymentMethodOnCart(InputSetPaymentMethodOnCartEntity input,
      {required bool isGuestUser}) {
    return _cartDatasource.setPaymentMethodOnCart(input, isGuestUser: isGuestUser).then((value) => value.fold(
          (errorHandler) => left(errorHandler),
          (cartDTO) => right(cartDTO.toDomain()),
        ));
  }
  ...
  Future<Either<ErrorHandler, Cart>> setGuestEmailOnCart({required String email, required String cartId}) {
    return _cartDatasource.setGuestEmailOnCart(email: email, cartId: cartId).then((value) => value.fold(
          (errorHandler) => left(errorHandler),
          (cartDTO) => right(cartDTO.toDomain()),
        ));
  }
  ...
  Future<Either<ErrorHandler, Cart>> deleteCouponFromCart({required String cartId, required bool isGuestUser}) {
    return _cartDatasource.deleteCouponFromCart(cartId: cartId, isGuestUser: isGuestUser).then((value) => value.fold(
          (errorHandler) => left(errorHandler),
          (cartDTO) => right(cartDTO.toDomain()),
        ));
  }
  ...
  Future<Either<ErrorHandler, List<ProductsItems>>> getCrossSellingProducts({required List<String> skus}) {
    return _cartDatasource.getCrossSellingProducts(skus: skus).then((value) => value.fold(
          (errorHandler) => left(errorHandler),
  ...
  Future<Either<ErrorHandler, SendTipResponse>> sendTip({required SendTip sendTip}) {
    return _cartDatasource.addTipToCart(sendTipDTO: sendTip.toDto()).then((value) => value.fold(
          (errorHandler) => left(errorHandler),
  ...
  Future<Either<ErrorHandler, List<EnabledShippingMethod>>> getEnabledShippingMethods() {
    return _cartDatasource.getEnabledShippingMethods().then((value) => value.fold(
          (errorHandler) => left(errorHandler),
  ...
  Future<Either<ErrorHandler, Cart>> removeAllItemsFromCart({required String cartId}) {
    return _cartDatasource.removeAllItemsFromCart(cartId: cartId).then((value) => value.fold(
          (errorHandler) => left(errorHandler),
          (cartDTO) => right(cartDTO.toDomain()),
        ));
  }
  ...
  Future<Either<ErrorHandler, AppointmentSelectedEntity>> setAppointmentInformationOnCart(
    ...
    return _cartDatasource
        .setAppointmentInformationOnCart(setAppointmentOnCartDTO: appointmentOnCartEntity.toDTO())
        .then((value) => value.fold(
              (errorHandler) => left(errorHandler),
              (cartDTO) => right(cartDTO.toDomain()),
            ));
  ...
  Future<Either<ErrorHandler, Cart>> setWarehouseAddressOnCart(
    ...
    return _cartDatasource
        .setWarehouseAddressOnCart(wareHouseAddressEntity, cartId,
            setShippingAddressOmsOptionsDTO: setShippingAddressOmsOptions.toDTO(), customerLogged: customerLogged)
        .then((value) => value.fold(
              (errorHandler) => left(errorHandler),
              (cartDTO) => right(cartDTO.toDomain()),
            ));
  ...
  Future<Either<ErrorHandler, String>> setOmsOptionsInCart(
    ...
    return _cartDatasource
        .setOmsOptionsInCart(addToCartOmsOptionsDTO: addToCartOmsOptions.toDTO(), cartId: cartId)
        .then((value) => value.fold(
              (errorHandler) => left(errorHandler),
              (cartId) => right(cartId),
            ));
