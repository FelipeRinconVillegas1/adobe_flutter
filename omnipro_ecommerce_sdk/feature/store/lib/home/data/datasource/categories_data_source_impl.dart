...
import 'package:store/home/data/datasource/categories_query.dart';
...
class CategoriesDataSourceImpl implements CategoriesDataSource {
  ...
  Future<Either<ErrorHandler, CategoriesDTO>> getCategoriesByFilter(
    ...
    return secureServerCall(
      () async {
        final response = await _graphQLService.query(getCategoriesQuery(), variables: {
