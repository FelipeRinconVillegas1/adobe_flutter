...
abstract class $CustomerTokensDTOCopyWith<$Res> {
  factory $CustomerTokensDTOCopyWith(
          CustomerTokensDTO value, $Res Function(CustomerTokensDTO) then) =
...
abstract class _$$CustomerTokensDTOImplCopyWith<$Res>
    implements $CustomerTokensDTOCopyWith<$Res> {
  factory _$$CustomerTokensDTOImplCopyWith(_$CustomerTokensDTOImpl value,
...
class __$$CustomerTokensDTOImplCopyWithImpl<$Res>
  ...
  __$$CustomerTokensDTOImplCopyWithImpl(_$CustomerTokensDTOImpl _value,
  ...
  $Res call({
    ...
    return _then(_$CustomerTokensDTOImpl(
      token: null == token
          ? _value.token
          : token // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$CustomerTokensDTOImpl implements _CustomerTokensDTO {
  const _$CustomerTokensDTOImpl(
      {required this.token, @JsonKey(name: 'refresh_token') this.refreshToken});
  ...
  Map<String, dynamic> toJson() {
    return _$$CustomerTokensDTOImplToJson(
      this,
    );
  }
}
