...
enum UnitMath { meters, kilometers, miles, yards }

/// Map related calculations class
class FlutterMapMath {
  /// converts kilometers to desired(meters, miles, yards) units
  double toRequestedUnit(UnitMath unit, double distanceInKm) {
    switch (unit) {
      case UnitMath.kilometers:
        return distanceInKm;
      case UnitMath.meters:
  ...
  double distanceBetween(
      double lat1, double lon1, double lat2, double lon2, UnitMath unit) {
