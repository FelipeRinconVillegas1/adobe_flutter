...
abstract class $CategoriesDTOCopyWith<$Res> {
  factory $CategoriesDTOCopyWith(
    CategoriesDTO value,
    $Res Function(CategoriesDTO) then,
...
abstract class _$$CategoriesDTOImplCopyWith<$Res>
  ...
  factory _$$CategoriesDTOImplCopyWith(
    _$CategoriesDTOImpl value,
    $Res Function(_$CategoriesDTOImpl) then,
...
class __$$CategoriesDTOImplCopyWithImpl<$Res>
  ...
  __$$CategoriesDTOImplCopyWithImpl(
    _$CategoriesDTOImpl _value,
    $Res Function(_$CategoriesDTOImpl) _then,
  ) : super(_value, _then);
...
class _$CategoriesDTOImpl implements _CategoriesDTO {
  ...
  Map<String, dynamic> toJson() {
    return _$$CategoriesDTOImplToJson(this);
  }
}
...
abstract class _CategoriesDTO implements CategoriesDTO {
  const factory _CategoriesDTO({
    required final List<CategoriesItemsDTO> items,
    @JsonKey(name: 'page_info') required final CategoriesPageInfoDTO pageInfo,
  }) = _$CategoriesDTOImpl;
...
abstract class $CategoriesItemsDTOCopyWith<$Res> {
  factory $CategoriesItemsDTOCopyWith(
    CategoriesItemsDTO value,
    $Res Function(CategoriesItemsDTO) then,
...
abstract class _$$CategoriesItemsDTOImplCopyWith<$Res>
    implements $CategoriesItemsDTOCopyWith<$Res> {
  factory _$$CategoriesItemsDTOImplCopyWith(
    _$CategoriesItemsDTOImpl value,
...
class __$$CategoriesItemsDTOImplCopyWithImpl<$Res>
  ...
  __$$CategoriesItemsDTOImplCopyWithImpl(
    _$CategoriesItemsDTOImpl _value,
...
class _$CategoriesItemsDTOImpl implements _CategoriesItemsDTO {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$CategoriesItemsDTOImplToJson(this);
  }
}
...
abstract class $CategoriesPageInfoDTOCopyWith<$Res> {
  factory $CategoriesPageInfoDTOCopyWith(
    CategoriesPageInfoDTO value,
...
/// @nodoc
class _$CategoriesPageInfoDTOCopyWithImpl<
  $Res,
...
class __$$CategoriesPageInfoDTOImplCopyWithImpl<$Res>
    extends
        _$CategoriesPageInfoDTOCopyWithImpl<$Res, _$CategoriesPageInfoDTOImpl>
    implements _$$CategoriesPageInfoDTOImplCopyWith<$Res> {
  __$$CategoriesPageInfoDTOImplCopyWithImpl(
    _$CategoriesPageInfoDTOImpl _value,
...
class _$CategoriesPageInfoDTOImpl implements _CategoriesPageInfoDTO {
  ...
  get copyWith =>
      __$$CategoriesPageInfoDTOImplCopyWithImpl<_$CategoriesPageInfoDTOImpl>(
        this,
        _$identity,
      );
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$CategoriesPageInfoDTOImplToJson(this);
  }
}
