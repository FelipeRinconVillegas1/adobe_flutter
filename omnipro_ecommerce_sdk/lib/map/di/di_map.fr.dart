...
import '../data/datasource/locator_datasource.dart';
import '../data/datasource/locator_datasource_impl.dart';
import '../data/repository/geocoding_repository.dart';
import '../data/repository/geoocoding_repository_impl.dart';
import '../data/repository/locator_repository.dart';
import '../data/repository/locator_repository_impl.dart';
import '../data/repository/place_autocomplete_repository.dart';
import '../data/repository/place_autocomplete_repository_impl.dart';
import '../domain/use_case/check_permission_use_case.dart';
import '../domain/use_case/current_position_use_case.dart';
import '../domain/use_case/get_details_place_by_coordinates_use_case.dart';
import '../domain/use_case/get_location_by_placeid_use_case.dart';
import '../domain/use_case/get_places_automcomplete_use_case.dart';
import '../domain/use_case/location_enable_use_case.dart';
import '../domain/use_case/request_permission_use_case.dart';
...
PlaceAutocompleteRepository placeAutocompleteRepository(PlaceAutocompleteRepositoryRef ref) {
  late final String key;
  if (Platform.isAndroid) {
    key = const String.fromEnvironment('GMAPS_ANDROID_API_KEY');//TODO ESTE PASAR CON UN CONFIG INIT INICIAL
  } else if (Platform.isIOS) {
    key = const String.fromEnvironment('GMAPS_IOS_API_KEY');//TODO ESTE PASAR CON UN CONFIG INIT INICIAL
  } else {
    key = '';
  }
